...
train_kinetics_movinet = datasets.Kinetics(VALIDATION, frames_per_clip= FRAMES, split='train', num_classes= '400', step_between_clips= STEPS_BETWEEN_CLIPS, transform = train_transform_movinet,  download= False, num_download_workers= 1, num_workers= 80)
train_kinetics_swin = datasets.Kinetics(VALIDATION, frames_per_clip= FRAMES, split='train', num_classes= '400', step_between_clips= STEPS_BETWEEN_CLIPS, transform = train_transform_swin,  download= False, num_download_workers= 1, num_workers= 80)
